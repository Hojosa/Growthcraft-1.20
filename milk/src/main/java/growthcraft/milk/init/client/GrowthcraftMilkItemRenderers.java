...
import growthcraft.core.lib.client.ItemRendererUtils;
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.APPENZELLER_CHEESE.toItemColor(), GrowthcraftMilkBlocks.APPENZELLER_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.ASIAGO_CHEESE.toItemColor(), GrowthcraftMilkBlocks.ASIAGO_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.CASU_MARZU_CHEESE.toItemColor(), GrowthcraftMilkBlocks.CASU_MARZU_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.CHEDDAR_CHEESE.toItemColor(), GrowthcraftMilkBlocks.CHEDDAR_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.EMMENTALER_CHEESE.toItemColor(), GrowthcraftMilkBlocks.EMMENTALER_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.GORGONZOLA_CHEESE.toItemColor(), GrowthcraftMilkBlocks.GORGONZOLA_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.GOUDA_CHEESE.toItemColor(), GrowthcraftMilkBlocks.GOUDA_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.MONTEREY_CHEESE.toItemColor(), GrowthcraftMilkBlocks.MONTEREY_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.PARMESAN_CHEESE.toItemColor(), GrowthcraftMilkBlocks.PARMESAN_CHEESE.get().asItem());
...
//        ItemRendererUtils.registerItem(event, Reference.ItemColor.PROVOLONE_CHEESE.toItemColor(), GrowthcraftMilkBlocks.PROVOLONE_CHEESE.get().asItem());
