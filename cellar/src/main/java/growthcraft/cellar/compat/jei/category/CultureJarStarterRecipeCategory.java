...
import growthcraft.core.lib.utils.TextureHelper;
import growthcraft.core.lib.utils.TickUtils;
...
public class CultureJarStarterRecipeCategory implements IRecipeCategory<CultureJarStarterRecipe> {
    ...
    public Component getTitle() {
        return Component.translatable("jei.growthcraft_cellar.category.culture_jar_starter");
    }
    ...
    @Override
    public void draw(CultureJarStarterRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawWordWrap(font, FormattedText.of("Leave the item slot empty for creating a starter."), 0, 7, 50, 0x404040);
