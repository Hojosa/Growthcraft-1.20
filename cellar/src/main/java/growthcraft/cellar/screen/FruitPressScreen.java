...
import growthcraft.core.lib.kaupenjoe.screen.renderer.FluidTankRenderer;
...
public class FruitPressScreen extends AbstractContainerScreen<FruitPressMenu> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(
            Reference.MODID, "textures/gui/fruit_press_screen.png"
    );

    private FluidTankRenderer fluidTankRenderer0;

    public FruitPressScreen(FruitPressMenu menu, Inventory inventory, Component component) {
