...
import growthcraft.bamboo.datagen.providers.GrowthcraftBambooBlockTagsProvider;
...
public class GrowthcraftBambooDataGenerators{
	...
	public static void gatherData(GatherDataEvent event) {
		...
		generator.addProvider(event.includeServer(), new GrowthcraftBambooBlockTagsProvider(packOutput, event.getLookupProvider(), Reference.MODID, null));
	}
}
