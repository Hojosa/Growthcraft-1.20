...
public class GrowthcraftBambooBlockTagsProvider extends BlockTagsProvider
{
    public GrowthcraftBambooBlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, String modId, @Nullable ExistingFileHelper existingFileHelper)
    {
